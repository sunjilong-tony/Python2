...
# server.bind(("192.168.102.101", 9001))
# server.listen(10)
# inputs = [server]
# outputs = []
# message_queue = {}
...
# def start():
#     while True:
#         print("开启主进程%s" % os.getppid())
#         print("主线程的名称 %s" % threading.current_thread().name)
#         print("等待连接")
#         client, addr = server.accept()
#         print(addr, "连接成功")
#         th = threading.Thread(target=run, args=(client, addr), name="th1")
#         th.start()
#         th.join()
